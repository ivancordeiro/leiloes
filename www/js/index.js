...
setInterval("atualizaLogin()", 10000);
...
var dadosLog = "tokenLogado=" + tokenLogado  ;
//alert('dados: ' + dadosLog);
...
dataType: "json",
type: "POST",
url: baseUrl + 'app_logando.php' + getPG + '&acao=atualizaLogin',
data: dadosLog ,
crossDomain: true,
cache: false,
...
alert('teste3: ' + retorno.token );

if( retorno.token != '' ){

alert('teste4');

onCreateDB( retorno.token, retorno.login );
atualizar();
